...
picture_number = 20
options = Options()
options.binary_location = r'C:\Program Files\Mozilla Firefox\firefox.exe'   # firefox location
...
def web_screenshot(path, filename):
    ...
    if opt.pathtoaddon is not None:
        driver.install_addon(opt.pathtoaddon)
