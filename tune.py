...
def objective(trial):
    ...
    testloader = DataLoader(ImageDataset(hparams["test_data_path"],size,hparams["crop_size"],hparams["scale_factor"],hparams["augment_data"]), batch_size=hparams["batch_size"], shuffle=True, num_workers=hparams["threads"])
...
study.optimize(objective, timeout=15000)
